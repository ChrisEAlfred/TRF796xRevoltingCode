...
iso14443bAnticollision(u08_t command, u08_t slots)
{
	...
	{	
		...
		// NOTE: This is attrocious code as k is not cleared before the loop
		// if there is a timeout on more than one interation of i, k must
		// wrap 4G before getting to FFF0 again
		k = 0; // Here is my fix for the above TI stupidity.
